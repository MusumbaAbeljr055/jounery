        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 md:gap-10 mb-8 sm:mb-10 md:mb-12">
          ...
          <div className="text-center sm:text-left">
            ...
            <div className="flex items-center justify-center sm:justify-start gap-2 sm:gap-3">
              <a href="https://github.com/Abbey055?tab=overview&from=2026-08-01&to=2026-08-31" target="_blank" rel="noopener noreferrer" className="w-8 h-8 sm:w-9 sm:h-9 rounded-full bg-[#EFA83C] text-white flex items-center justify-center hover:bg-[#d9952f] transition">
              ...
              <a href="https://www.youtube.com/channel/UC0Lpz_wUqQGWEAC7FkgTwbQ" target="_blank" rel="noopener noreferrer" aria-label="Visit Abbey on YouTube" className="w-8 h-8 sm:w-9 sm:h-9 rounded-full bg-[#EFA83C] text-white flex items-center justify-center hover:bg-[#d9952f] transition">
